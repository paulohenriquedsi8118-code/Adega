...
<?php
session_start(); // IMPORTANTE: Adicione esta linha no início do arquivo
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<div class="container mt-5">
    ...
    <!-- BOTÕES DE NAVEGAÇÃO (AGORA COM REPOSIÇÃO) -->
    ...
    <div class="row mb-5">
        ...
        <!-- Outros cards de métricas futuras podem ser adicionados aqui -->
    </div>
